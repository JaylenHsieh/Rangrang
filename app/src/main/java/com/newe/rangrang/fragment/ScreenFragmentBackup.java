 ...
 */
@Deprecated
public class ScreenFragmentBackup extends Fragment implements EasyPermissions.PermissionCallbacks {
    ...
    @OnClick({R.id.fab_sound, R.id.circleImageView})
